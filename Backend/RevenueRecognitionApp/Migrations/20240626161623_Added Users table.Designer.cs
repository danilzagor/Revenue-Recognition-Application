...
namespace RevenueRecognition.Migrations
{
    ...
    [Migration("20240626161623_Added Users table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RevenueRecognition.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueRecognition.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RevenueRecognition.Models.Transaction", b =>
                {
                    b.HasOne("RevenueRecognition.Models.Client", null)
                        .WithMany("Transactions")
                        .HasForeignKey("ClientId");

                    b.HasOne("RevenueRecognition.Models.Contract", "Contract")
                        .WithMany("Transactions")
